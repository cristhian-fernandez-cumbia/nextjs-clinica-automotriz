...
const MaintenanceSearch: React.FC<MaintenanceSearchProps> = ({vehiculo}) => {
  ...
  return (
    <div>
      {vehiculo ? (
        <div className='pt-[60px] pl-4 pr-14 flex flex-col items-center'>
          ...
          <div className='flex flex-row gap-5 mb-3 lg:mb-8'>
            <div className='flex flex-col lg:flex-row lg:gap-5'>
              <div className='border-2 border-gray-300 min-w-32 text-center font-medium py-1 mb-3 lg:mb-0 text-sm lg:text-base text-black'>VEHÍCULO</div>
          ...
          <div className='flex flex-col-reverse lg:flex-row justify-between mb-6 lg:mb-0'>
            <div>
              <span className='text-xs font-bold relative top-[2px] lg:ml-16 text-black'>Nota:</span>
              <div className='text-xs lg:w-56 leading-[14px] lg:relative lg:left-16 text-black'>* Se recomienda cada 06 meses o cada 10 MIL KM</div>
            </div>
            <div className='flex flex-col items-center lg:flex-row'>
              ...
              <Button className='bg-primary py-3 lg:py-0 lg:h-8 text-lg font-medium text-white px-6 rounded-lg hover:bg-red-700 hover:cursor-pointer lg:mt-10 w-72 mb-4 l:mb-0'>SEPARAR CITA</Button>
            </div>
          </div>
        </div>
      ) : (
