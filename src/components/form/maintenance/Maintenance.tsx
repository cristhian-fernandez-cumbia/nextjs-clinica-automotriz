  ...
  return (
    <>
      <div className='relative mt-16 lg:mt-0 -bottom-56 lg:-bottom-0'>
        <div className='w-40 bg-red-600 h-40 absolute -top-5 -left-5 z-30 rounded-lg'></div>
        <div className='bg-white rounded-lg py-6 lg:py-8 px-6 w-64 lg:w-80 z-30 relative'>
          <form onSubmit={handleBuscarSubmit}>
            ...
            <button className="bg-red-500 text-white px-7 lg:px-10 py-2 rounded-lg hover:bg-red-700 font-bold absolute -bottom-4 lg:bottom-6 -right-24 hover:cursor-pointer z-10" type="submit" onClick={openModal}>BUSCAR AHORA </button>
          </form>
        </div>
      </div>
