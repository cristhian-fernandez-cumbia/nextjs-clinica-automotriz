  ...
  return (
    <div className={` shadow-lg w-40 lg:w-60 h-[195px] lg:h-[270px] ${main ? 'bg-yellow-400 border-2 border-yellow-400' : 'bg-white'}`}>
      ...
      <div className='py-2 px-2 lg:px-4'>
        <h3 className="text-[11px] lg:text-[15px] font-bold text-center leading-3 lg:leading-4 h-[36px] flex justify-center items-center text-black">{fullname}</h3>
        <div className='mt-1 lg:mt-3 flex flex-row justify-between'>
          ...
          <Button className='border-2 border-primary text-[8px] lg:text-[9px] rounded-md px-1 lg:px-3 py-[2px] text-primary font-bold hover:cursor-pointer'>
            AGENDA TU CITA
          </Button>
        </div>
      </div>
