  ...
  return (
    <div className='px-10 md:px-16 lg:px-24 xl:px-36 2xl:px-44 mb-10'>
      <div className='flex flex-col items-center mt-5'>
        ...
        <h3 className='bg-yellow-400 inline-block py-2 px-4 rounded-lg text-base lg:text-xl font-bold mb-8 lg:mb-6'>{dataServicesCourtesy.data.subtitle}</h3>
      </div>
      <div className='flex flex-col items-center space-y-10 lg:space-y-0 lg:flex-row lg:space-x-10 lg:justify-center'>
        {servicesData.map(service =>(
          <div key={`service-${service.idService}`} className='w-[400px]'>
            ...
            <div className='bg-yellow-400 flex items-end py-4 px-8 justify-between'>
              <div>
                <h4 className='text-md font-extrabold'>{service.title}</h4>
                <h5 className='text-[10px] font-semibold'>{service.subtitle}</h5>
              </div>
              <div className='flex flex-row items-center'>
                <span className='text-[12px] font-semibold mr-1'>DETALLES</span>
