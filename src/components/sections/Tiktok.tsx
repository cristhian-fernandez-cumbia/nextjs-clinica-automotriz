      ...
      <div className='bg-white flex justify-center flex-col rounded-lg  py-6  w-full lg:w-[800px]'>
        <div className='flex justify-center items-center mb-3'>
          ...
          <div className='ml-4'>
            ...
            <div className='flex'>
              <div>
                <p className='font-bold text-black'>1684</p>
                <p className='text-xs text-gray-500'>Following</p>
              </div>
              <div className='ml-4'>
                <p className='font-bold text-black'>374.8K</p>
                <p className='text-xs text-gray-500'>Followers</p>
              </div>
              <div className='ml-4'>
                <p className='font-bold text-black'>1.5M</p>
        ...
        <div className='text-center mb-4'>
          <p className='text-sm lg:text-base text-black'>Taller Automotriz mutimarcas 😎</p>
          <p className='text-sm lg:text-base text-black'>¡Atención con previa cita!</p>
        </div>
