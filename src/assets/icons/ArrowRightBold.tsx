  ...
  return (
    <svg width="20" height="27" viewBox="0 0 20 27" fill="none" className={props?.className}>
      <g filter="url(#filter0_d_421_121)">
        <path d="M6.25256 2.07129L4.78589 3.64272L12.5383 11.4999L4.78589 19.357L6.25256 20.9284L15.6811 11.4999L6.25256 2.07129Z" fill="white"/>
      ...
      <defs>
        <filter id="filter0_d_421_121" x="0.940213" y="0.0361328" width="18.6267" height="26.6989" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
